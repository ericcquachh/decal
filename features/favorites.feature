...
Scenario: User successfully favorites a class
	...
	And I should see the particular course in favorites
	And I should not see other courses in favorites
...
Scenario: Not Logged User should cannot favorite
	Given I am on the courses page
	And I click "logout"
	And I should not see the "favorite" button
	Then I visit the dashboard page
	And I should not see any courses in favorites