...
section1 = Section.new(section_title: "1", days: "TuTh", status: "Open", start_time: Section.time_to_int("8:00AM"), end_time: Section.time_to_int("9:00AM"))
section1.course = course1
section1.save

section2 = Section.new(section_title: "2", days: "MWF", status: "Full", start_time: Section.time_to_int("9:00AM"), end_time: Section.time_to_int("10:00AM"))
section2.course = course2
section2.save

section3 = Section.new(section_title: "3", days: "ThF", status: "Full", start_time: Section.time_to_int("10:00AM"), end_time: Section.time_to_int("11:00AM"))
...
section6 = Section.new(section_title: "6", days: "TuTh", status: "Open", start_time: Section.time_to_int("3:00PM"), end_time: Section.time_to_int("4:00PM"))
section6.course = course5
section6.save

section7 = Section.new(section_title: "7", days: "M", status: "Full", start_time: Section.time_to_int("5:00PM"), end_time: Section.time_to_int("6:30PM"))
