...
Course.create!(title: "Quantum Consciousness", category: "Cognitive Science", units:"2", days:"TuTh", time:"5PM-6PM"  , status:"Open")  
Course.create!(title: "Taiwanese Language", category: "Languages", units:"1", days:"MW", time: "5PM-6:30PM", status:"Full")  
